...
# from memory import MemoryQwen2ForCausalLM, MemoryGPT2ForCausalLM
from trl import ModelConfig, get_kbit_device_map, get_quantization_config
from llm import LinearConfig, LinearCausalLM, MemoryConfig, MemoryCausalLM
...
def get_model(model_args: ModelConfig, training_args: SFTConfig) -> AutoModelForCausalLM:
    ...
    model_config = AutoConfig.from_pretrained(model_args.model_name_or_path, trust_remote_code=model_args.trust_remote_code)
