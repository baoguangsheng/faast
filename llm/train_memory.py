...
from .alignment import ScriptArguments, get_dataset_from_disk, get_model, get_tokenizer
from .memory.memory_sft_trainer import MemorySFTTrainer, MemorySFTConfig
...
if __name__ == "__main__":
    parser = TrlParser((ScriptArguments, MemorySFTConfig, ModelConfig))
